...
if (isset($_POST) && !empty($_POST)) {
	...
	if (!$erro) {
		...
		if (!empty($user_id)) {
			...
			$inserir_usuario->execute(array($form_usuario,  md5($form_senha), $form_nome, $user_id));
			...
			$inserir_usuario->execute(array($form_usuario, md5($form_senha), $form_nome));
		}
	}
}
?>
...
<div class="container">
	<div>
		<hr>
		<p>Cadastra ou edita usuário já cadastrado.</p>
		<hr>
	</div>
	<form action="" method="post">
		<table>
			<tr>
				...
				<td></td>
				<td>Usuário<br><input type="text" name="form_usuario" required></td>
				<td></td>
